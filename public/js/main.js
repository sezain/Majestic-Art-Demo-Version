...
function cursorInit() {
    ...
    const initCursor = () => {
        ...
        const render = () => {
            innerCursor.style.transform = `translate(${clientX - cw}px, ${
                clientY - ch
            }px)`;
            ...
            .on("enter", function (event) {
                ...
                for (let i = 0; i < animChilds.length; i++) {
                    ...
                    if (el.getAttribute("data-animation") == "cover-down") {
                        ...
                        el.getAttribute("data-animation") == "cover-right"
                    ) {
                        el.classList.add("cover-right-anim");
                        continue;
                    } else if (
                        el.getAttribute("data-animation") == "slide-down"
                    ) {
                        el.classList.add("slide-anim");
                        continue;
                    } else if (
                        el.getAttribute("data-animation") == "slide-left"
                    ) {
                        el.classList.add("slide-anim");
                        continue;
                    } else if (
                        el.getAttribute("data-animation") == "slide-up"
                    ) {
                        el.classList.add("slide-anim");
                        continue;
                    } else if (
...
function portfolioSliderFull() {
    ...
    // Num pagination
    var sliderPortfolioPagination = sliderPortfolioItem.querySelector(
...
function portfolioSliderFullReveal() {
    ...
    setTimeout(() => {
        ...
        var sliderPagination = slider.querySelector(
            ".portfolio-slider-pagination"
        );
    ...
    setTimeout(() => {
        ...
        var sliderRevealContent =
            sliderCurrentSlide.querySelectorAll(".cover-right");
    ...
    window.onscroll = () => {
        ...
        for (let s in sections)
            if (
                ...
                document
                    .querySelector(`.menu-anchor-list li a[href*=${id}]`)
...
if (document.getElementById("swup")) {
    ...
    const swup = new Swup({
        ...
        cache: true,
        plugins: [swupScroll, new SwupJsPlugin(jsOptions)],
    });
...
function init() {
    ...
    if (
        ...
        !document.querySelector(".preloader-num")
    ) {
    ...
    if (
        document.querySelector("[data-animation]:not([data-animation-child])")
    ) {
        singleAnimation();
    }
    // Animation end
