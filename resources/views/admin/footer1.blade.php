<!-- begin:: Footer -->
					<div class="kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-footer__copyright">
								{{date('Y')}}&nbsp;&copy; {{Config::get('constants.options.footerCopyright')}}
							</div>
		...
		<!-- end::Scrolltop -->
                    ...
                    <script src="{{url('/')}}/assets/js/demo1/pages/crud/forms/widgets/bootstrap-markdown.js" type="text/javascript"></script>
