                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="kt-portlet">
                                    ...
                                    @endif
                                    <form method="POST" action="{{ url('admin/create-art') }}" class="kt-form" enctype="multipart/form-data">
                                        <div class="kt-portlet__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="name" type="text" class="form-control" name="person" value="{{ old('person') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="name" type="text" class="form-control" name="location" value="{{ old('location') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="name" type="text" class="form-control" name="discover" value="{{ old('discover') }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="name" type="text" class="form-control" name="video" value="{{ old('video') }}">
