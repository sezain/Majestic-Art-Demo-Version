                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="kt-portlet">
                                    ...
                                    <form method="POST" action="{{ url('admin/edit-blog') }}" class="kt-form" enctype="multipart/form-data">
                                        <div class="kt-portlet__body">
                                            ...
                                            <!-- add new fields-->
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="keywords_content" type="text" class="form-control" name="keywords_content" value="{{ $record->keywords_content }}">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <textarea class="form-control" name="excerpt" value="{{ old('excerpt') }}">{{ $record->excerpt }}</textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
