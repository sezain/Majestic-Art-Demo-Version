                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="kt-portlet">
                                    ...
                                    @endif
                                    <form method="POST" action="{{ route('categories.store') }}" class="kt-form" enctype="multipart/form-data">
                                        <div class="kt-portlet__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="email" type="text" class="form-control" name="slug" value="{{ old('slug') }}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('Slug') }}</label>
