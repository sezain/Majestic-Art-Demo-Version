                                ...
                                <div class="kt-portlet__head-toolbar">
                                    <div class="kt-portlet__head-wrapper">
                                        <div class="kt-portlet__head-actions">
                                            ...
                                            <a href="{{url('admin/create-event')}}" class="btn btn-brand btn-elevate btn-icon-sm">
                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{url('admin/edit-event/'.$record->id)}}"><i class="la la-edit"></i></a>
                                                <a href="{{url('admin/delete-event/'.$record->id)}}">X</i></a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
