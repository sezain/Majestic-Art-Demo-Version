...
<head>
    ...
    <title>
        The Majestic Arts is art curator, buyer and seller company.
    </title>
                            ...
                            <div class="col-xl-7 col-lg-8 offset-lg-1">
                                <div class="slide-content slide-content-light slide-content-intro">
                                    <h2 class="slide-title">
                                        <span>“The true work of art is but a
                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-8 offset-lg-1">
                                <div class="slide-content slide-content-light slide-content-second">
                                    <h2 class="slide-title">
                                        <span>“White is poison to a picture,
                                            use it only in
                                            highlights.”</span>
                                    </h2>
                                    <p class="slide-subtitle">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-8 offset-lg-1">
                                <div class="slide-content slide-content-light slide-content-second">
                                    <h2 class="slide-title">
                                        <span>“I paint because the spirits
                                            whisper madly inside my
                                            head.”</span>
                                    </h2>
                                    <p class="slide-subtitle">
                                        <span>El Greco</span>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-7 col-lg-8 offset-lg-1">
                                <div class="slide-content slide-content-light slide-content-second">
                                    <h2 class="slide-title">
                                        <span>“Art washes away from the soul
    ...
    <section id="secdd" class="ok intro section-large section-80vh" style="
                ...
                background-image: url(https://demo.majesticarts.com/public/img/6.jpg);
                background-size: 100%;
            ...
            <div class="row" style="margin-top: 50px">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 text-black">
                    ...
                    <p data-animation-child class="text-lead text-black slide-up delay-1" data-animation="slide-up"
                        ...
                        The Majestic Arts is a Premier Art curator par
                        excellence with rich connections to Royalty, Art
                        Institutions and High Net Worth Individuals. The
                        Majestic Arts expertise covers extensive and diverse
                        topics, from Indian, Islamic and Renaissance works,
                        to Medieval and Impressionist Art among others.
                        Majestic Arts provides a platform for buying and
                        selling art paintings, engaging in market
                        discussions regarding specific art pieces,and has
                        already facilitated sales of artworks that are
                        cumulatively worth in excess of $6 billion. The
                        Majest Art gallery in Dubai offers an impressive
                        collection.
                    </p>
                </div>
            </div>
                ...
                <div class="col-xl-12 col-lg-12">
                    <div data-animation-container="" class="section-title section-title-medium animated">
                        ...
                        <h2 data-animation-child="" style="text-align: center; width: 100%"
                            ...
                            <span>The assurance of buying unique
                                pieces.</span>
                        </h2>
                    </div>
                </div>
                ...
                <div data-animation-container="" class="col-md-3 animated">
                    <a class="col-boxed" data-swup="" href="#">
                        <div class="slow bg-image lazy" data-bg="url(public/img/a-2.jpg)" data-was-processed="true"
                            style="
                                    background-image: url(public/img/a-2.jpg);
                                "></div>
                        <h3>
                ...
                <div data-animation-container="" class="col-md-3 animated">
                    <a class="col-boxed" data-swup="" href="#">
                        <div class="slow bg-image lazy" data-bg="url(public/img/a-3.jpg)" data-was-processed="true"
                            style="
                                    background-image: url(public/img/a-3.jpg);
                                "></div>
                        <h3>
                ...
                <div data-animation-container="" class="col-md-3 animated">
                    <a class="col-boxed" data-swup="" href="#">
                        <div class="slow bg-image lazy" data-bg="url(public/img/a-4.jpg)" data-was-processed="true"
                            style="
                                    background-image: url(public/img/a-4.jpg);
                                "></div>
                        <h3>
                ...
                <div data-animation-container="" class="col-md-3 animated">
                    <a class="col-boxed" data-swup="" href="#">
                        <div class="slow bg-image lazy" data-bg="url(public/img/a-5.jpg)" data-was-processed="true"
                            style="
                                    background-image: url(public/img/a-5.jpg);
                                "></div>
                        <h3>
                            The Hussar<br /><span>Frederic Remington</span>
                        </h3>
                    </a>
                </div>
            </div>
                                        ...
                                        <div class="testimonials-item">
                                            <div class="col-lg-7 col-md-7 col-sm-12" style="
                                                ...
                                                <p data-animation-child
                                                    ...
                                                    rebirth) was a movement
                                                    that took place across
                                                    Europe during the 14th,
                                                    15th and 16th
                                                    centuries.It was
                                                    characterized by an
                                                    interest in nature,
                                                    greater focus on
                                                    individualism, interest
                                                    in the world and
                                                    concepts that had been
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                                <img style="
                                                            width: 100%;
                                                            margin-top: 20px;
                                                        " src="public/img/the-annunciation.png"
                                                    alt="Stars paintings" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="testimonials-item">
                                            <div class="col-lg-7 col-md-7 col-sm-12" style="
                                                ...
                                                <p data-animation-child
                                                    ...
                                                    data-animation="slide-up">
                                                    Medieval Art in the
                                                    Western world covers
                                                    over a thousand years of
                                                    art across Europe, the
                                                    Middle East and North
                                                    Africa. Medieval Art
                                                    includes several
                                                    distinct movements and
                                                    periods based on genre,
                                                    region and time period,
                                                    such as Early Christian
                                                    Art, Byzantine Art,
                                                    Anglo-Saxon Art, Viking
                                                    Art, Insular Art,
                                                    Romanesque Art and
                                                    Gothic Art, amongst
                                                    others.
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                                <img style="
                                                            width: 100%;
                                                            margin-top: 20px;
                                                        " src="public/img/Portfolio/the-lion-hunt.jpg"
                                                    alt="Stars paintings" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="testimonials-item">
                                            <div class="col-lg-7 col-md-7 col-sm-12" style="
                                                ...
                                                <p data-animation-child
                                                    class="testimonials-comment text-white text-center slide-up delay-2 custom-slide"
                                                    data-animation="slide-up">
                                                    Western Art encompasses
                                                    all visual art produced
                                                    in Europe (and later,
                                                    the Americas)- from the
                                                    prehistoric age right
                                                    through to
                                                    post-modernism. What
                                                    began in the form of
                                                    rock and cave paintings
                                                    during the Paleolithic
                                                    Age, eventually evolved
                                                    into Classical
                                                    Renaissance,
                                        ...
                                        <div class="testimonials-item">
                                            <div class="col-lg-7 col-md-7 col-sm-12" style="
                                                ...
                                                <p data-animation-child
                                                    class="testimonials-comment text-white text-center slide-up delay-2 custom-slide"
                                                    data-animation="slide-up">
                                                    Modern art represents
                                                    art produced during the
                                                    19th and 20th centuries,
                                                    and is mainly associated
                                                    with pieces that eschew
                                                    the traditions of the
                                                    past in favour of the
                                                    spirit of
                                                    ...
                                                    of art. Modern art tends
                                                    to shy away from the
                                                    creation of a narrative
                                                    and focuses more on the
                                                    abstract, allowing each
                                                    viewer to interpret a
                                                    work of art
                                                    subjectively.
                                                </p>
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                                <img style="
                                                            width: 100%;
                                                            margin-top: 20px;
                                                        " src="public/img/Portfolio/fab-pacaso.jpg"
                                                    alt="Stars paintings" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="testimonials-item">
                                            <div class="col-lg-7 col-md-7 col-sm-12" style="
                                                ...
                                                <p data-animation-child
                                                    ...
                                                    varied art movements
                                                    that contradict certain
                                                    aspects of modern art.
                                                    Postmodernism is
                                                    characterized by certain
                                                    distinct features, such
                                                    as the use of text as
                                                    the central artistic
                                                    element, the use of
                                                    several distinct
                                                    entities to create a new
                                                    whole, the emphasis on
                                                    the concept rather than
                                                    the aesthetic and the
                                                    recycling of past themes
                                                    and ideas with the
                                                    addition of a modern-day
                                                    twist.
                                                </p>
                                        ...
                                        <div class="testimonials-item">
                                            <div class="col-lg-7 col-md-7 col-sm-12" style="
                                                ...
                                                <p data-animation-child
                                                    class="testimonials-comment text-white text-center slide-up delay-2 custom-slide"
                                                    data-animation="slide-up">
                                                    Indian art covers art
                                                    that has been produced
                                                    by ancient Indian
                                                    civilizations, ranging
                                                    as far back as 3500 BC.
                                                    It includes a variety of
                                                    art forms, such as
                                                    paintings, sculptures,
                                                    tapestries, pottery and
                                                    textile arts.
                                                    Geographically, it
                                                    covers art from the
                                                    entire Indian
                                                    subcontinent, which
                                                    includes what is now the
                                                    countries of India,
                                                    Pakistan, Sri Lanka,
                                                    Bangladesh, Nepal,
                                                    Bhutan and the eastern
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                                <img style="
                                                            width: 100%;
                                                            margin-top: 20px;
                                                        " src="public/img/Portfolio/horses.jpg"
                                                    alt="Stars paintings" />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="testimonials-item">
                                            <div class="col-lg-7 col-md-7 col-sm-12" style="
                                                ...
                                                <p data-animation-child
                                                    class="testimonials-comment text-white text-center slide-up delay-2 custom-slide"
                                                    data-animation="slide-up">
                                                    Islamic art encomasses
                                                    all visual arts produced
                                                    by culturally Islamic
                                                    populations, ranging
                                                    from architecture,
                                                    calligraphy, glass,
                                                    pottery and textile
                                                    arts. One of the most
                                                    distinctive features of
                                                    Islamic art is the use
                                                    of arabesque, which is a
                                                    repetitive, stylized
                                                    form of artistic
                                                    decoration that relies
                                                    on rhythmic linear
                                                    patterns of interlacing
                                                    tendrils or foliage.
                                                    Arabesque is often used
                                                    to symbolize the
                                                    transcendent,
                                            ...
                                            <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                                <img style="
                                                            width: 100%;
                                                            margin-top: 20px;
                                                        " src="public/img/Portfolio/indian-arts.jpg"
                                                    alt="Stars paintings" />
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-5 col-lg-5">
                    <img src="public/img/masterpiece.png" width="100%" style="
                ...
                <div class="col-xl-6 col-lg-6">
                    ...
                    <p data-animation-child="" class="text-lead text-black slide-up delay-1 slide-anim"
                        ...
                        <br />
                        Joseph Stella depicted the world around him,
                        offering an idiosyncratic vision of the early
                        twentieth century. Supported by his older brothers,
                        who had already achieved success in America, Stella
                        arrived in New York in 1896 as part of a wave of
                        Italian immigrants from poverty-stricken southern
                        Italy. After receiving traditional academic
                        training, which he quickly rejected, Stella joined
                        the ranks of Modernist art in 1913, painting dynamic
                        and jarring compositions of the Brooklyn Bridge in
                        what became known as the Futurist style.
                    </p>
                    <br />
                    <br />
                    <br />
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6">
                    <a href="" class="borderd-box icon-arrow-right">
                        ...
                        <p>
                            Majestic Art provides the best scientific
                ...
                <div class="col-xl-6 col-lg-6">
                    <a href="" class="borderd-box icon-arrow-right">
                        ...
                        <p>
                            Majestic Art also serves to restore different
                            pieces of art...
                        </p>
                    </a>
                </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <a href="" class="borderd-box icon-arrow-right">
                        ...
                        <p>
                            A masterpiece is a formation in any region of
                            different arts blessed with...
                        </p>
                    </a>
                </div>
                ...
                <div class="col-12">
                    <div data-animation-container class="section-title section-title-small text-center">
                        ...
                        <p class="text-black" style="font-size: 15px">
                            The world's greatest arts and antiques
                            collection
                        </p>
                    </div>
                </div>
                            ...
                            <div class="blog-card">
                                <a data-animation-child data-swup href="{{ url('news/' . $posts[0]->slug) }}"
                                    ...
                                    <div class="lazy" data-bg="">
                                        <img height="300" src="{{ asset('public/event/' . $posts[0]->image) }}" />
                                    </div>
                                </a>
                        ...
                        <div data-animation-container class="blog-card-outer">
                            <div class="blog-card">
                                <a data-animation-child data-swup href="{{ url('news/' . $posts[1]->slug) }}"
                                    class="cursor-color">
                                    <div class="lazy" data-bg="">
                                        <img height="300" src="{{ asset('public/event/' . $posts[1]->image) }}" />
                                    </div>
                                </a>
                                <div class="blog-card-content">
                                    <div data-animation-child class="slide-up delay-8" data-animation="slide-up">
                        ...
                        <div data-animation-container class="blog-card-outer">
                            <div class="blog-card">
                                <a data-animation-child data-swup href="{{ url('news/' . $posts[2]->slug) }}"
                                    class="cursor-color">
                                    <div class="lazy" data-bg="">
                                        <img height="300" src="{{ asset('public/event/' . $posts[2]->image) }}" />
                                    </div>
                                </a>
                                <div class="blog-card-content">
                                    <div data-animation-child class="slide-up delay-8" data-animation="slide-up">
