...
<footer class="footer" style="background-color: #fbf6f1;">
    ...
    <div class="container">
        ...
        <div class="row justify-content-between footer-bottom">
            <div class="col-md-6">
                <div class="copyright">
                    <p class="text-goldden">{{date('Y')}} @ Majestic Arts. All rights reserved</p>
                </div>
            </div>
...
<!-- 3D Container -->
<script src="{{asset('public/js/plug/plugins.js')}}"></script>  
<script src="{{asset('public/js/plug/universal-tilt.js')}}"></script>  
<script type="text/javascript">
