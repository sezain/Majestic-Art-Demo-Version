...
<head>
    ...
    <!-- FontAwesome -->
     ...
     <link rel="canonical" href="https://majesticarts.com/blog" />
...
<section id="firstSection" class="page-header section-80vh bg-gradient-black bg-black">
        ...
        <div class="row">
            <div class="col-xl-7 offset-xl-1">
                <div class="breadcrumb-wrap">
                    <ul class="breadcrumb slide-over">
                        <li class="breadcrumb-item"><a class="link text-black" href="<?php echo e(url('/')); ?>">Home</a></li>
            ...
            <div class="col-xl-11 offset-xl-1">
                <h1 class="page-header-title text-black">
                    <span class="slide-over">Blog</span>
                </h1>
            </div>
            <div class="col-xl-7 offset-xl-1">
                <p class='page-header-text text-lead text-black'>
                    <span class="slide-over">The Majestic Arts</span>
                </p>
            </div>
        </div>
        <!-- row end -->
    ...
    <div class="bottom-left-links">
        <div>
            <a href="#" class="link text-black">Behance</a>
        </div>
        <div>
                        ...
                        <div data-animation-container class="blog-item bg-black">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 data-animation-child class="blog-title slide-up delay-8" data-animation="slide-up">
                                    <a class="link" data-swup href="<?php echo e(url('blog/'.$record->slug)); ?>"><?php echo e($record->title); ?></a>
                                </h3>
...
<!-- blog page main end -->
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/majesud3/public_html/demo.majesticarts.com/resources/views/blogs.blade.php ENDPATH**/ ?>