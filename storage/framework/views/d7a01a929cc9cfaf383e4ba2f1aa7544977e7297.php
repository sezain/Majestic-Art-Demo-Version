...
<head>
    ...
    <!-- FontAwesome -->
     ...
     <title>History of Western Art | Majestic Arts</title>
     <meta name="description" content="Majestic Art encompasses the history of western art and famous western paintings. Western art and architecture is the art of Europe from the prehistoric age."/>
     <meta name="Keywords" content="Western Art, history of western art, famous western paintings, old western art, western art and architecture">
     <meta name='robots' content='index,follow' />
     <link rel="canonical" href="https://majesticarts.com/western-art" />
...
<?php echo $__env->make('navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <section id="firstSection" class="page-header section-80vh bg-gradient-black bg-black blog-top-bg" style="background: url(<?php echo e(url('/public/img/art-category/Western-Art.jpg')); ?>); background-size: 100%; margin-top:115px; background-repeat: no-repeat;">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 offset-xl-1">
                        <h1 class="page-header-title text-white">
                            <span class="slide-over">WESTERN ART</span>
                        </h1>
                    </div>
                    <div class="col-xl-12 offset-xl-1">
                        <p class='page-header-text text-lead text-white'>
                        <span class="slide-over">Majestic Art encompasses the history of western art and famous western paintings.
                        </p>
                    </div>
                </div>
                <!-- row end -->
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="blog-item">
                                ...
                                <div class="blog-content">
                                    ...
                                    <br><br>
                                    Classical Art eventually morphed into Modern art and Postmodern Art. One of the most notable features of modern and <a href="https://majesticarts.com/postmodern-art">Postmodern Art</a> is that while all art that preceded it focussed mainly on the issue of religion, Modern and Postmodern Art contain hardly any references to the subject, instead choosing to focus on political subjects.
                                    <br><br>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\m_art\resources\views/western-art.blade.php ENDPATH**/ ?>