...
<head>
    ...
    <!-- FontAwesome -->
     ...
     <title>About Our Company | The Majestic Arts</title>
     <meta name="description" content="The Majestic Arts was founded with a vision to provide a 360-degree range of services in the art industry. It is the best art selling and buying platform."/>
     <meta name="Keywords" content="The Majestic Arts about, art buying services, art selling services">
     <meta name='robots' content='index,follow' />
     <link rel="canonical" href="https://majesticarts.com/about" />
            ...
            <div data-animation-container class="container">
                ...
                <div class="row">
                        ...
                        <!-- <div data-animation-child class="row slide-up delay-2" data-animation="slide-up">
                            <div class="col-lg-6 col-md-12">
                                <p class="intro-text text-black">
                                   There is currently a major gap in the art authentication market for new, innovative methods of testing. Majestic Arts addresses this pressing requirement through its unique multispectral imaging process, which is far more efficient than the current X-ray testing that most authenticators use while facilitating the buying, selling, scouting and evaluation of arts and artifacts.
                                </p>
                            </div> 
                    ...
                    <div data-animation-child class="section-title section-title-large slide-up port_img tilt" style="transform: perspective(1500px);" data-animation="slide-up">
                        <a href="#">
                            <img src="public/img/a-1.jpg" alt="Client">
                        </a>
                    </div>
                </div>
...
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/majesud3/public_html/majesticarts/resources/views/about.blade.php ENDPATH**/ ?>