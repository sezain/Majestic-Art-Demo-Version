                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="kt-portlet">
                                        ...
                                        <?php endif; ?>
                                        <form method="POST" action="<?php echo e(url('admin/create-blog')); ?>" class="kt-form" enctype="multipart/form-data">
                                            <div class="kt-portlet__body">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="description_content" type="text" class="form-control" name="description_content" value="<?php echo e(old('description_content')); ?>">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <input id="keywords_content" type="text" class="form-control" name="keywords_content" value="<?php echo e(old('keywords_content')); ?>">
...
<?php echo $__env->make('admin/footer1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/majesud3/public_html/majesticarts/resources/views/admin/new-blog.blade.php ENDPATH**/ ?>