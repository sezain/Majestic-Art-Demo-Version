<!-- begin:: Footer -->
		...
		<script src="<?php echo e(url('/')); ?>/assets/js/demo1/pages/crud/datatables/basic/headers.js" type="text/javascript"></script>

		<!--begin::Page Scripts(used by this page) -->
		<!--<script src="<?php echo e(url('/')); ?>/assets/js/demo1/pages/dashboard.js" type="text/javascript"></script>-->

		<!--end::Page Scripts -->
	</body>

	<!-- end::Body -->
</html><?php /**PATH /home/majesud3/public_html/majesticarts/resources/views/admin/footer.blade.php ENDPATH**/ ?>