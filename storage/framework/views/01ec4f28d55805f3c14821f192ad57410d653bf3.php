    ...
    <div class="kt-grid kt-grid--hor kt-grid--root">
        <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
            ...
            <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="kt-portlet">
                                    ...
                                    <?php endif; ?>
                                    <form method="POST" action="<?php echo e(route('categories.store')); ?>" class="kt-form" enctype="multipart/form-data">
                                        <div class="kt-portlet__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    <input id="email" type="text" class="form-control" name="slug" value="<?php echo e(old('slug')); ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="email" class="col-md-4 col-form-label text-md-right"><?php echo e(__('Slug')); ?></label>
                ...
                <?php echo $__env->make('admin/footer1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/majesud3/public_html/majesticarts/resources/views/admin/create-category.blade.php ENDPATH**/ ?>