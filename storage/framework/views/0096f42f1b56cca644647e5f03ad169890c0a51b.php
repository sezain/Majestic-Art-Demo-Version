                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="kt-portlet">
                                        ...
                                        <?php endif; ?>
                                        <form method="POST" action="<?php echo e(url('admin/create-event')); ?>" class="kt-form" enctype="multipart/form-data">
...
<?php echo $__env->make('admin/footer1', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/majesud3/public_html/majesticarts/resources/views/admin/new-event.blade.php ENDPATH**/ ?>