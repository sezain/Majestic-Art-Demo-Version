...
<section id="firstSection"  class="page-header section-80vh bg-gradient-black bg-black blog-top-bg" style="background: url(<?php echo e(url('/public/img/newslatter.jpg')); ?>); background-size: 100%; margin-top:115px; background-repeat: no-repeat;">
    <!-- container start -->
    <div class="container">
        <!-- row start -->
        <div class="row">
                        ...
                        <div data-animation-container class="blog-item">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 data-animation-child class="blog-title slide-up delay-8" data-animation="slide-up">
                                    <a class="link  text-black-color" data-swup href="<?php echo e(url('blog/'.$record->slug)); ?>"><?php echo e($record->title); ?></a>
                                </h3>
...
</script><?php /**PATH C:\Users\aarth\Desktop\Majestic-Art-Demo-Version\resources\views/blogs.blade.php ENDPATH**/ ?>