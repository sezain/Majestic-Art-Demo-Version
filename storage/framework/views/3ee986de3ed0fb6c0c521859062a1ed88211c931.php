...
<section id="firstSection" class="swiper-container slider-main slider-main-reveal bg-black">
    <div class="swiper-wrapper">
        <div class="swiper-slide slider-slide">
            <div class="slider-inner overlay-black bg-image lazy" data-bg="url(<?php echo e(asset('img/pages/home/1.jpg')); ?>)"
        ...
        <div class="swiper-slide slider-slide">
            <!-- slide content start -->
            <div class="slider-inner overlay-black bg-image lazy" data-bg="url(<?php echo e(asset('img/pages/home/3.jpg')); ?>)"
                data-swiper-parallax="1000">
                <!-- container start -->
                <div class="container">
                    <!-- row start -->
        ...
        <div class="swiper-slide slider-slide">
            <!-- slide content start -->
            <div class="slider-inner overlay-black bg-image lazy" data-bg="url(<?php echo e(asset('img/pages/home/2.jpg')); ?>)"
                data-swiper-parallax="1000">
                <!-- container start -->
                <div class="container">
                    <!-- row start -->
        ...
        <div class="swiper-slide slider-slide">
            <!-- slide content start -->
            <div class="slider-inner overlay-black bg-image lazy" data-bg="url(<?php echo e(asset('img/pages/home/4.jpg')); ?>)"
                data-swiper-parallax="1000">
                <!-- container start -->
                <div class="container">
                    <!-- row start -->
    ...
    <a href="#secdd" class="scroll-down" address="true"><img src="<?php echo e(asset('img/assets/scroll-down.png')); ?>" alt="scroll down" /></a>
</section>
<!-- slider end -->
...
<section id="secdd" class="ok intro section-large section-80vh" style="
        ...
        background-image: url(<?php echo e(asset('img/pages/home/6.jpg')); ?>);
        background-size: 100%;
        ...
        <div class="row" style="margin-top: 50px">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <div data-animation-child class="section-title section-title-large slide-up port_img"
                    ...
                    <img class="layer3-style" style="min-width: 100%;" src="<?php echo e(asset('img/pages/home/info_section_image.png')); ?>"
                        alt="Stars paintings" />
                </div>
            </div>
        ...
        <div class="row" style="margin-bottom: 120px" >
            <div data-animation-container="" class="col-md-3 animated">
                <a class="col-boxed to-id" data-swup="" href="#paintings">
                    <div class="slow bg-image lazy" data-bg="url(<?php echo e(asset('img/pages/home/a-2.jpg')); ?>)" data-was-processed="true"
                        style="background-image: url(<?php echo e(asset('img/pages/home/a-2.jpg')); ?>)"></div>
                    <h3>
            ...
            <div data-animation-container="" class="col-md-3 animated">
                <a class="col-boxed to-id" data-swup="" href="#paintings">
                    <div class="slow bg-image lazy" data-bg="url(<?php echo e(asset('img/pages/home/a-3.jpg')); ?>)" data-was-processed="true"
                        style="background-image: url(<?php echo e(asset('img/pages/home/a-3.jpg')); ?>)"></div>
                    <h3>
            ...
            <div data-animation-container="" class="col-md-3 animated">
                <a class="col-boxed to-id" data-swup="" href="#paintings">
                    <div class="slow bg-image lazy" data-bg="url(<?php echo e(asset('img/pages/home/a-4.jpg')); ?>)" data-was-processed="true"
                        style="background-image: url(<?php echo e(asset('img/pages/home/a-4.jpg')); ?>)"></div>
                    <h3>
            ...
            <div data-animation-container="" class="col-md-3 animated">
                <a class="col-boxed to-id" data-swup="" href="#paintings">
                    <div class="slow bg-image lazy" data-bg="url(<?php echo e(asset('img/pages/home/a-5.jpg')); ?>)" data-was-processed="true"
                        style="background-image: url(<?php echo e(asset('img/pages/home/a-5.jpg')); ?>)"></div>
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/pages/home/the-annunciation.png')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/pages/home/the-lion-hunt.jpg')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/pages/home/majestic-arts-collection.jpg')); ?>"
                                                alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/pages/home/fab-pacaso.jpg')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/pages/home/avignon-majestic-arts.jpg')); ?>"
                                                alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/pages/home/horses.jpg')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/pages/home/indian-arts.jpg')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-5 col-lg-5">
                <img src="<?php echo e(asset('img/pages/home/masterpiece.png')); ?>" width="100%" style="
...
<section class="section-large" style="padding-top: 100px !important; background: #fbf8f1">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <a href="<?php echo e(route('services')); ?>" class="fancy-butn icon-arrow-right">Discover More Services</a>
        </div>
    </div>
</section>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 last-sec">
                <div data-animation-child class="section-title section-title-large slide-up port_img"
                    ...
                    <a href="<?php echo e(route('events')); ?>">
                        ...
                        <img src="<?php echo e(asset('img/pages/home/l1.jpg')); ?>" alt="Stars paintings" />
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 last-sec">
                <div data-animation-child class="section-title section-title-large slide-up delay-8 port_img"
                    ...
                    <a href="<?php echo e(route('collection')); ?>">
                        ...
                        <img src="<?php echo e(asset('img/pages/home/l2.jpg')); ?>" alt="Stars paintings" />
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 last-sec">
                <div data-animation-child class="section-title section-title-large slide-up port_img"
                    ...
                    <a href="<?php echo e(route('contact')); ?>">
                        ...
                        <img src="<?php echo e(asset('img/pages/home/l3.jpg')); ?>" alt="Stars paintings" />
                    </a>
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 last-sec">
                <div data-animation-child class="section-title section-title-large slide-up delay-8 port_img"
                    ...
                    <a href="#">
                        ...
                        <img src="<?php echo e(asset('img/pages/home/l4.jpg')); ?>" alt="Stars paintings" />
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <div class="blog-card">
                                <a data-animation-child data-swup href="<?php echo e(route('article', $post->slug)); ?>"
                                    ...
                                    <div class="lazy" data-bg="">
                                        <img height="300" src="<?php echo e(asset('/img/event/' . $post->image)); ?>" />
                                    </div>
                                </a>
                ...
                <div class="row">
                    ...
                    <form action="<?php echo e(route('subscribe')); ?>" method="POST"
                        ...
                        <button style="float: right; border: none">
                            <img src="<?php echo e(asset('img/assets/singnup-button.png')); ?>" style="float: right; margin-top: -25px" />
                        </button>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\majesticarts\resources\views/home.blade.php ENDPATH**/ ?>