...
<?php $__env->stopPush(); ?> <?php $__env->startSection('main-content'); ?>
<!-- slider  start -->
<section id="firstSection" class="swiper-container slider-main slider-main-reveal bg-black">
    <div class="swiper-wrapper">
        <div class="swiper-slide slider-slide">
            <div class="slider-inner overlay-black bg-image lazy" data-bg="url(<?php echo e(asset('img/Headers/Sliders/Main/1.jpg')); ?>)"
        ...
        <div class="swiper-slide slider-slide">
            <!-- slide content start -->
            <div class="slider-inner overlay-black bg-image lazy" data-bg="url(<?php echo e(asset('img/Headers/Sliders/Main/3.jpg')); ?>)"
                data-swiper-parallax="1000">
                <!-- container start -->
                <div class="container">
                    <!-- row start -->
        ...
        <div class="swiper-slide slider-slide">
            <!-- slide content start -->
            <div class="slider-inner overlay-black bg-image lazy" data-bg="url(<?php echo e(asset('img/Headers/Sliders/Main/2.jpg')); ?>)"
                data-swiper-parallax="1000">
                <!-- container start -->
                <div class="container">
                    <!-- row start -->
        ...
        <div class="swiper-slide slider-slide">
            <!-- slide content start -->
            <div class="slider-inner overlay-black bg-image lazy" data-bg="url(<?php echo e(asset('img/Headers/Sliders/Main/4.jpg')); ?>)"
                data-swiper-parallax="1000">
                <!-- container start -->
                <div class="container">
                    <!-- row start -->
    ...
    <a href="#secdd" class="scroll-down" address="true"><img src="<?php echo e(asset('img/scroll-down.png')); ?>" alt="scroll down" /></a>
</section>
<!-- slider end -->
...
<section id="secdd" class="ok intro section-large section-80vh" style="
        ...
        background-image: url(<?php echo e(asset('img/6.jpg')); ?>);
        background-size: 100%;
        ...
        <div class="row" style="margin-bottom: 120px">
            <div data-animation-container="" class="col-md-3 animated">
                <a class="col-boxed" data-swup="" href="#">
                    <div class="slow bg-image lazy" data-bg="url(<?php echo e(asset('img/a-2.jpg')); ?>)" data-was-processed="true"
                        style="background-image: url(<?php echo e(asset('img/a-2.jpg')); ?>)"></div>
                    <h3>
            ...
            <div data-animation-container="" class="col-md-3 animated">
                <a class="col-boxed" data-swup="" href="#">
                    <div class="slow bg-image lazy" data-bg="url(<?php echo e(asset('img/a-3.jpg')); ?>)" data-was-processed="true"
                        style="background-image: url(<?php echo e(asset('img/a-3.jpg')); ?>)"></div>
                    <h3>
            ...
            <div data-animation-container="" class="col-md-3 animated">
                <a class="col-boxed" data-swup="" href="#">
                    <div class="slow bg-image lazy" data-bg="url(<?php echo e(asset('img/a-4.jpg')); ?>)" data-was-processed="true"
                        style="background-image: url(<?php echo e(asset('img/a-4.jpg')); ?>)"></div>
                    <h3>
            ...
            <div data-animation-container="" class="col-md-3 animated">
                <a class="col-boxed" data-swup="" href="#">
                    <div class="slow bg-image lazy" data-bg="url(<?php echo e(asset('img/a-5.jpg')); ?>)" data-was-processed="true"
                        style="background-image: url(<?php echo e(asset('img/a-5.jpg')); ?>)"></div>
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/the-annunciation.png')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/Portfolio/the-lion-hunt.jpg')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/Portfolio/majestic-arts-collection.jpg')); ?>"
                                                alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/Portfolio/fab-pacaso.jpg')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/Portfolio/avignon-majestic-arts.jpg')); ?>"
                                                alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/Portfolio/horses.jpg')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
                                    ...
                                    <div class="testimonials-item">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-12" style="float: left">
                                            <img style="
                                                    width: 100%;
                                                    margin-top: 20px;
                                                " src="<?php echo e(asset('img/Portfolio/indian-arts.jpg')); ?>" alt="Stars paintings" />
                                        </div>
                                    </div>
                                </div>
                                <!-- row end -->
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xl-5 col-lg-5">
                <img src="<?php echo e(asset('img/masterpiece.png')); ?>" width="100%" style="
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-6 col-sm-12 last-sec">
                <div data-animation-child class="section-title section-title-large slide-up port_img"
                    style="transform: perspective(1500px)" data-animation="slide-up">
                    <a href="#">
                        <img src="<?php echo e(asset('img/l1.jpg')); ?>" alt="Stars paintings" />
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 last-sec">
                <div data-animation-child class="section-title section-title-large slide-up delay-8 port_img"
                    style="transform: perspective(1500px)" data-animation="slide-up">
                    <a href="#">
                        <img src="<?php echo e(asset('img/l2.jpg')); ?>" alt="Stars paintings" />
                        <div class="info-pages-box">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 last-sec">
                <div data-animation-child class="section-title section-title-large slide-up port_img"
                    style="transform: perspective(1500px)" data-animation="slide-up">
                    <a href="#">
                        <img src="<?php echo e(asset('img/l3.jpg')); ?>" alt="Stars paintings" />
                        <div class="info-pages-box">
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 last-sec">
                <div data-animation-child class="section-title section-title-large slide-up delay-8 port_img"
                    style="transform: perspective(1500px)" data-animation="slide-up">
                    <a href="#">
                        <img src="<?php echo e(asset('img/l4.jpg')); ?>" alt="Stars paintings" />
                        <div class="info-pages-box">
