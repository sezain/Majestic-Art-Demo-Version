...
<head>
    ...
    <!-- FontAwesome -->
     ...
     <title>The Majestic Arts Exhibitions</title>
     <meta name="description" content="The Majestic Arts Exhibitions"/>
     <meta name="Keywords" content="The Majestic Arts Exhibitions">
     <meta name='robots' content='noindex,follow' />
     <link rel="canonical" href="https://majesticarts.com/exhibitions" />
        ...
        <div class="row">
            ...
            <div class="col-xl-12 offset-xl-1">
                <h1 class="page-header-title text-white">
                    <span class="slide-over">Exhibitions</span>
                </h1>
            </div>
            <div class="col-xl-12 offset-xl-1">
                <p class='page-header-text text-lead text-white'>
                    <span class="slide-over">Upcoming Exhibitions September 2020</span>
                </p>
            </div>
        </div>
        <!-- row end -->
                        ...
                        <div data-animation-container class="blog-item bg-black">
                            ...
                            <div class="blog-content">
                                ...
                                <h3 data-animation-child class="blog-title slide-up delay-8" data-animation="slide-up">
                                    <a class="link" data-swup href="<?php echo e(url('exhibitions/'.$record->slug)); ?>"><?php echo e($record->title); ?></a>
                                </h3>
...
<!-- blog page main end -->
<?php echo $__env->make('footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/majesud3/public_html/majesticarts/resources/views/exhibitions.blade.php ENDPATH**/ ?>